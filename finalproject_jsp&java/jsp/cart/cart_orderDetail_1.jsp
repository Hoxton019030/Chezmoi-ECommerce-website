            ...
            <div class="row px-xl-5">
                <div class="col-lg-8 border-secondary  border mb-5" style="padding-left: 0; padding-right:0;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            <form:input  path="customerName" type="text" class="form-control p-4 mb-2" placeholder="彭建華" />
                        </div>
                        <div class="d-flex justify-content-between pt-1 mb-2">
                            <h6 class=" font-weight-medium">電話號碼</h6>
                        </div>
                        <div class="input-group">
                            <form:input path="phone" type="text" class="form-control p-4 mb-2" placeholder="09XXXXXXX" />
                        </div>
                        <div class="d-flex justify-content-between pt-1 mb-2">
                            <h6 class=" font-weight-medium">電子信箱</h6>
                        </div>
                        <div class="input-group">
                            <form:input path="email" type="text" class="form-control p-4" placeholder="abc@gmail/yahoo..." />
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-8 border-secondary  border mb-5" style="padding-left: 0; padding-right:0;">
                    ...
                    <div class="card-body">
                        <div class="card-body">
                            ...
                            <a class="a" href="https://emap.pcsc.com.tw/#" target="_blank">7-11門市查詢 ( ex: 門市店號：136288 ,
                                門市店名：工協 )</a>
                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card border-secondary mb-5">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between pt-1">
                                <h6 class=" font-weight-semi-bold m-0">合計:</h6>
                            </div>
                        </div>
