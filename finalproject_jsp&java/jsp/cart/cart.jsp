...
<body>
            ...
            <table class="table table-bordered text-center mb-0">
                ...
                <c:forEach items="${Cart}" var="c">
                    <tr>
                        ...
                        <td class="align-middle"><img src="${contextRoot}/img/product/0812/" alt="" style="width: 5em;">
                        ...
                        <td class="align-middle total">${c.total}</td>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-2 pt-1">
                    	...
                    	<c:forEach items="${Payment}" var="p">
                            <option value="">${p.paymentWay}</option>
                       </c:forEach>
                        </select>
                    </div>
                    <div class="d-flex justify-content-between pt-1">
                    ...
                    <div class="d-flex justify-content-between mb-2 pt-1">
                        <select name="shopping way" style="width: 100em;height:3em ;">
                          <c:forEach items="${Shipping}" var="s">
                            <option value="">${s.shippingWay}</option>
                       </c:forEach>
                        </select>
                    </div>
                    <div class="d-flex justify-content-between pt-1">
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            <h6 class="font-weight-medium">運費: 70</h6>
                        </div>
                    </div>
                    <form class="mb-5 btn btn-block" action="http://localhost:8081/finalProject/cart" method="get" target="_self">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                         ...
                         <a href="shop.html"><button class="btn btn-block btn-primary my-3 py-3">繼續購物</button>
                        </a>
                        <a href="<c:url value='/cartOrderDetail' />"><button
    ...
    <script src="${contextRoot}/mail/contact.js" type="text/javascript"></script>
	 ...
	 <script>
//     	const subtotal = $('.total').text()
//     	$('.subtotal').text("小計:"+subtotal)
    </script>
