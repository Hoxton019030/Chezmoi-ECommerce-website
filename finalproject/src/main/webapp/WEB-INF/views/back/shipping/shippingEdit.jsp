                ...
                <div class="container-fluid pt-1">
                    ...
                    <div class="row ml-1">
                        <div class="row col-lg-9">
                          <form:form action="${contextRoot}/back/updateShipping" method="post" modelAttribute="UpdateShipping">
                            <table class="table table-bordered text-center">
                                ...
                                <tbody class="align-middle">
                                    <tr>
                                        <td class="align-middle"><form:input path="shippingId" type="text" value="${UpdateShipping.shippingId}" /></td>
                                        <td class="align-middle"><form:input path="shippingWay" type="text" value="${UpdateShipping.shippingWay}"/></td>
                                        <td class="align-middle"><form:input path="shippingFee" type="text" value="${UpdateShipping.shippingFee}" style="width: 2em;"/></td>
                                        <td class="align-middle"><form:input path="shippingState" type="text" value="${UpdateShipping.shippingState}"/></td>
                                    </tr>
                                </tbody>
                            </table>
                             <button type="submit" class="btn btn-primary mb-3">送出修改</button>
                             <a href="${contextRoot}/back/shipping" class="text-primary font-weight-medium ml-2">返回查詢</a>
                            </form:form>
                        </div>
                    </div>
                    </div>
