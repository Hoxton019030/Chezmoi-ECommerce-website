			...
			<div class="collapse navbar-collapse  justify-content-between"
				...
				<div class="navbar-nav mr-auto align-items-center py-0">
					<a href="${contextRoot}/index" class="nav-item nav-link active"><img
						src="${contextRoot}/img/logo.jpg" width="50" height="50"> </a> <a
						href="${contextRoot}/shop" class="nav-item nav-link">Shop</a> <a
				...
				<div class="navbar-nav ml-auto py-0">
					<a href="Product_set.html" class="nav-item nav-link"><img
						src="${contextRoot}/img/set.png" width="20" height="20"></a> <a
						href="wish.html" class="nav-item nav-link"><img
						src="${contextRoot}/img/wish.png" width="20" height="20"></a> <a
						href="${contextRoot}/cartAll" class="nav-item nav-link"><img
						src="${contextRoot}/img/cart.png" width="20" height="20"></a> <a
						href="member.html" class="nav-item nav-link"><img
						src="${contextRoot}/img/user.png" width="20" height="20"></a>
				</div>
			</div>
		</nav>
	</div>
