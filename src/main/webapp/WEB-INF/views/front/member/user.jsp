                        ...
                        <div class="collapse navbar-collapse  justify-content-between" id="navbarCollapse">
                            ...
                            <div class="navbar-nav ml-auto py-0">
                                <a href="Product_set.html" class="nav-item nav-link"><img src="img/set.png" width="20"
                                        height="20"></a>
                                <a href="wish.html" class="nav-item nav-link"><img src="img/wish.png" width="20"
                                        height="20"></a>
                                <a href="cart.html" class="nav-item nav-link"><img src="img/cart.png" width="20"
                                        height="20"></a>
                                <a href="member.html" class="nav-item nav-link"><img src="img/user.png" width="20"
                                        height="20"></a>
                            </div>
                    </nav>
                </div>
