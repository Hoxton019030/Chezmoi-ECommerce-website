                                        ...
                                        <tbody class="align-middle">
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <form:input path="paymentWay" id="way" type="text" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <button type="submit" class="btn btn-primary mb-3" id="add">新建</button>
                                ...
                                <tbody class="align-middle">
                                    <c:forEach items="${Payments}" var="p">
                                        <tr>
                                            ...
                                            <td><a href="${contextRoot}/back/updatePayment?id=${p.paymentId}"
