                    ...
                    <div class="container-fluid mb-5">
                        <div class="row border-top">
                            ...
                            <div class="row col-lg-9 justify-content-center pl-0">
                                ...
                                <div class="col-lg-3 border-secondary border mb-5 mt-3 mr-2"
                                    style="padding-left: 0; padding-right:0;">
                                    <form:form action="${contextRoot}/Back/addCoupon" method="post"
                                        modelAttribute="couponadd">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control p-4 mb-2" name="couponName"
                                                    placeholder="歡慶中秋節" required />
                                            </div>
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control p-4 mb-2"
                                                    placeholder="Chezmoi152" name="couponCode" required />
                                            </div>
                                            <div class="d-flex justify-content-between pt-2 mb-2" style="clear:both;">
                                                <h6 class=" font-weight-medium">折扣金額</h6>
                                            </div>
                                            <div class="input-group">
                                                <input type="text" class="form-control p-4 mb-2" placeholder="100"
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control p-4 mb-2"
                                                    placeholder="2022-9-26 00:00" name="dateStart" id="dateStart"
                                                    required /><span id="dateStartsp"></span>
                                            </div>
                                            <div class="input-group">
                                                <input type="text" class="form-control p-4 mb-2"
                                                    placeholder="2022-11-20 23:59" name="dateEnd" id="dateEnd"
                                                    required /><span id="dateEndsp"></span>
                                            </div>
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control p-4 mb-2" placeholder="ON/OFF"
                                                    name="couponState" value="ON" required />
                                            </div>
                                ...
                                <div class="col-lg-8 border-secondary  border mb-5 mt-3"
                                    style="padding-left: 0; padding-right:0;">
                                    <div class="card-header border bg-secondary border-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row table-responsive ml-0 mb-5 p-0">
                                            <table class="table table-bordered text-center mb-0"
                                                style="word-break: break-all;word-wrap: break-word;white-space: pre-wrap;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <%-- <td class="align-middle">${workCoupon.minimum}</td>
                                                                ...
                                                                <%-- <td class="align-middle"><a
                                                                        ...
                                                                        href="${contextRoot}/Back/deleteCoupon?couponId=${workCoupon.couponId}"><button
                                                                            class="btn btn-sm btn-primary"><i --%>
                                                                                <!--                                                     class="fa fa-times"></i></button></a> -->
                                                                                <!--                                         </td> -->
                                                                                <td class="align-middle"><a
                                                                                        href="${contextRoot}/Back/editCoupon?couponId=${workCoupon.couponId}">
                                                                                        <button
                                                                                            class="btn btn-sm btn-primary mb-4"><i
                                                                                                class="fa fa-times"></i></button></a>
                                                                                </td>
                                                        </tr>
