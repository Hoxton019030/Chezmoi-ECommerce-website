...
//	}
	...
	public Orders viewOrder(Model model) {
		Orders findTopOrder = ordersService.findTopOrder();
		Orders order = new Orders();
		order.setOrderDate(findTopOrder.getOrderDate());
		order.setOrderId(findTopOrder.getOrderId());
		order.setNotes(findTopOrder.getNotes());
